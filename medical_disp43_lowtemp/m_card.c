...
#define   KEY_SET_AND_UP    0x18     //设定+上调
#define   KEY_UP_AND_DOWN   0x11     //上调+下调
#define   KEY_SET_AND_DOWN  0x09     //IC卡注册 
...
uint8_t card_rx_data_deal(void)
{
    ...
    {                                                                      
        ...
        if(guc_com_rx_buffer[8] == 0x40)   //进入注册状态,根据主板发送的led2值,因血液柜没有led1数码管
        {                                                                
            PFDL_Init();  
