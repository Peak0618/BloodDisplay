...
void test_mode_error_code_deal(void)  //     显示错误代码标号
{
    ...
    else if (guc_test_card_error_sum >= 10)
    {
        guc_test_mode_error_code = 0x02;          //E02   与card模拟串口通讯故障
    }
    /*
...
void test_mode_error_code_set(void)  
{
    ...
    //----------------------------------------------------------------------
    /*if(guc_card_rx_buffer[0] != 0x4A )           //E02   与card模拟串口通讯故障
    {
...
void test_mode_error_code_view(void)
{
    ...
    guc_led_buffer[1] = 0xff;  //所有LED亮
    //----------------------------------

    if(guc_test_mode_error_code == 0)          //没有错误,显示pass
    {
        guc_led_buffer[2] = data_8;         
        guc_led_buffer[3] = data_8;     
        guc_led_buffer[4] = data_8;         
    }  
    else                                        //显示错误代码
    { 
        ...
        {
            guc_led_buffer[4] = data_2;           //E02   与card模拟串口通讯故障
        }
        /*
